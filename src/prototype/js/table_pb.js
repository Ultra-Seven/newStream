...
goog.exportSymbol('proto.SimpleVizTable', null, global);
goog.exportSymbol('proto.SimpleVizTable.Col', null, global);
goog.exportSymbol('proto.SimpleVizTable.Schema', null, global);
 ...
 * @constructor
 */
proto.SimpleVizTable = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SimpleVizTable.repeatedFields_, null);
};
goog.inherits(proto.SimpleVizTable, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.SimpleVizTable.displayName = 'proto.SimpleVizTable';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.SimpleVizTable.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.SimpleVizTable.prototype.toObject = function(opt_includeInstance) {
  return proto.SimpleVizTable.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SimpleVizTable} msg The msg instance to transform.
 * @return {!Object}
 */
proto.SimpleVizTable.toObject = function(includeInstance, msg) {
  var f, obj = {
    schema: (f = msg.getSchema()) && proto.SimpleVizTable.Schema.toObject(includeInstance, f),
    colsList: jspb.Message.toObjectList(msg.getColsList(),
    proto.SimpleVizTable.Col.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SimpleVizTable}
 */
proto.SimpleVizTable.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SimpleVizTable;
  return proto.SimpleVizTable.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SimpleVizTable} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SimpleVizTable}
 */
proto.SimpleVizTable.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.SimpleVizTable.Schema;
      reader.readMessage(value,proto.SimpleVizTable.Schema.deserializeBinaryFromReader);
      msg.setSchema(value);
      break;
    case 2:
      var value = new proto.SimpleVizTable.Col;
      reader.readMessage(value,proto.SimpleVizTable.Col.deserializeBinaryFromReader);
      msg.addCols(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.SimpleVizTable.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SimpleVizTable.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SimpleVizTable} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.SimpleVizTable.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSchema();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.SimpleVizTable.Schema.serializeBinaryToWriter
    );
  }
  f = message.getColsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.SimpleVizTable.Col.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.SimpleVizTable.Col = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SimpleVizTable.Col.repeatedFields_, null);
};
goog.inherits(proto.SimpleVizTable.Col, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.SimpleVizTable.Col.displayName = 'proto.SimpleVizTable.Col';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.SimpleVizTable.Col.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.SimpleVizTable.Col.prototype.toObject = function(opt_includeInstance) {
  return proto.SimpleVizTable.Col.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SimpleVizTable.Col} msg The msg instance to transform.
 * @return {!Object}
 */
proto.SimpleVizTable.Col.toObject = function(includeInstance, msg) {
  var f, obj = {
    valList: jspb.Message.getRepeatedFloatingPointField(msg, 1)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SimpleVizTable.Col}
 */
proto.SimpleVizTable.Col.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SimpleVizTable.Col;
  return proto.SimpleVizTable.Col.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SimpleVizTable.Col} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SimpleVizTable.Col}
 */
proto.SimpleVizTable.Col.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.SimpleVizTable.Col.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SimpleVizTable.Col.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SimpleVizTable.Col} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.SimpleVizTable.Col.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValList();
  if (f.length > 0) {
 ...
 * @return {!Array.<number>}
 */
proto.SimpleVizTable.Col.prototype.getValList = function() {
  return /** @type {!Array.<number>} */ (jspb.Message.getRepeatedFloatingPointField(this, 1));
};


/** @param {!Array.<number>} value */
proto.SimpleVizTable.Col.prototype.setValList = function(value) {
  jspb.Message.setField(this, 1, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.SimpleVizTable.Col.prototype.addVal = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};


proto.SimpleVizTable.Col.prototype.clearValList = function() {
  this.setValList([]);
};
 ...
 * @constructor
 */
proto.SimpleVizTable.Schema = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SimpleVizTable.Schema.repeatedFields_, null);
};
goog.inherits(proto.SimpleVizTable.Schema, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.SimpleVizTable.Schema.displayName = 'proto.SimpleVizTable.Schema';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.SimpleVizTable.Schema.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.SimpleVizTable.Schema.prototype.toObject = function(opt_includeInstance) {
  return proto.SimpleVizTable.Schema.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SimpleVizTable.Schema} msg The msg instance to transform.
 * @return {!Object}
 */
proto.SimpleVizTable.Schema.toObject = function(includeInstance, msg) {
  var f, obj = {
    nameList: jspb.Message.getField(msg, 1)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SimpleVizTable.Schema}
 */
proto.SimpleVizTable.Schema.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SimpleVizTable.Schema;
  return proto.SimpleVizTable.Schema.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SimpleVizTable.Schema} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SimpleVizTable.Schema}
 */
proto.SimpleVizTable.Schema.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.SimpleVizTable.Schema.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SimpleVizTable.Schema.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SimpleVizTable.Schema} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.SimpleVizTable.Schema.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNameList();
  if (f.length > 0) {
    writer.writeRepeatedString(
 ...
 * @return {!Array.<string>}
 */
proto.SimpleVizTable.Schema.prototype.getNameList = function() {
  return /** @type {!Array.<string>} */ (jspb.Message.getField(this, 1));
};


/** @param {!Array.<string>} value */
proto.SimpleVizTable.Schema.prototype.setNameList = function(value) {
  jspb.Message.setField(this, 1, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.SimpleVizTable.Schema.prototype.addName = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};


proto.SimpleVizTable.Schema.prototype.clearNameList = function() {
  this.setNameList([]);
};
 ...
 * @return {?proto.SimpleVizTable.Schema}
 */
proto.SimpleVizTable.prototype.getSchema = function() {
  return /** @type{?proto.SimpleVizTable.Schema} */ (
    jspb.Message.getWrapperField(this, proto.SimpleVizTable.Schema, 1));
};


/** @param {?proto.SimpleVizTable.Schema|undefined} value */
proto.SimpleVizTable.prototype.setSchema = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.SimpleVizTable.prototype.clearSchema = function() {
  this.setSchema(undefined);
};
 ...
 * @return {!boolean}
 */
proto.SimpleVizTable.prototype.hasSchema = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * If you change this array by adding, removing or replacing elements, or if you
 * replace the array itself, then you must call the setter to update it.
 * @return {!Array.<!proto.SimpleVizTable.Col>}
 */
proto.SimpleVizTable.prototype.getColsList = function() {
  return /** @type{!Array.<!proto.SimpleVizTable.Col>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.SimpleVizTable.Col, 2));
};


/** @param {!Array.<!proto.SimpleVizTable.Col>} value */
proto.SimpleVizTable.prototype.setColsList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.SimpleVizTable.Col=} opt_value
 * @param {number=} opt_index
 * @return {!proto.SimpleVizTable.Col}
 */
proto.SimpleVizTable.prototype.addCols = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.SimpleVizTable.Col, opt_index);
};


proto.SimpleVizTable.prototype.clearColsList = function() {
  this.setColsList([]);
};
